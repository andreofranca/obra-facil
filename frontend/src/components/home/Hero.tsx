  ...
  return (
    ...
    >
      <div className="flex-1 w-full flex flex-col justify-center max-w-2xl animate-fade-in-up">
        ...
        <p className="text-neutral-muted font-sans text-lg md:text-xl leading-relaxed mb-10 max-w-[540px]">
        ...
        <form
          ...
          method="GET"
          role="search"
          className="flex flex-col sm:flex-row items-center bg-neutral-white border border-neutral-border rounded-2xl sm:rounded-full shadow-elevated p-2 max-w-[560px] w-full focus-within:ring-2 focus-within:ring-brand-primary/50 transition-all duration-300"
        >
